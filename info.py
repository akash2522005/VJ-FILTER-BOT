...
URL = "https://luffy-xbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://luffy-xbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://luffy-xbot.onrender.com/".format(FQDN)
else:
    URL = "https://luffy-xbot.onrender.com/".format(FQDN)
