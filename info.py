...
API_ID = int(environ.get('API_ID', '26741548'))
API_HASH = environ.get('API_HASH', '97ea8cd3620c3ab09ab344c381f2998a')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1714480980').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001957349872').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://akashmodi527:KZavrpPk1lmIFv33@cluster0.6gpxub0.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '32e5bde14ac62b9ed75bb79d054882319b175576')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001909838011))
